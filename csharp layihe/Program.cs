    ...
    public static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string enteredpass = Console.ReadLine();
                ...
                if (username == enteredname && password == enteredpass)
                {
                    Menu();
                }
                else
            ...
            while (true)
            {
                ...
                switch (branchChoice)
                {
                    ...
                    case 4:
                        ...
                        {
                            Console.WriteLine($"Couldn't find branch with this name ");
                        }
                        break;
                    case 5:
            ...
            while (true)
            {
                ...
                switch (employeeChoice)
                {
                    ...
                    case 2:
                        ...
                        {
                            Console.WriteLine($"\nEmployee with this name  not found");
                        }
                        break;
        ...
        public static void SeedDataBase2()
        {
